...
class ViewController: UIViewController {
    ...
    var words = [["CRYPTO","I am currency but people cannot touch me"],
                 ["IPHONE","I am a fruit but people cant eat me"],
                 ["DIETCOKE","Not a coke"],
                 ["MOUSE","Device used instead of track pad"],
                 ["TESLA","I dont drink fuel but i am a car"]]

    var images =  ["crypto","iphone","diet","mouse","Tesla"]
